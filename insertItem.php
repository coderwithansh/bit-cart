...
mysqli_query($con,"insert into item_info(item_name,item_detail,image_path,parent_category,item_rate,item_discount,reg_date) 
values('$a','$b','$img','$d','$e','$f',now())") or die("Query error");
